...
<section id="searchMatch">
	<h2>
		<i class="fas fa-search"></i> 원하시는 요양보호사님을 찾아보세요
	</h2>

    <form id="searchMatchForm"> <!-- action, method attributes deleted -->
		<div class="checkbox" id="careTime">
			<h3>돌봄시간</h3>
			<label><input type="checkbox" name="time" value="전체"
				id="allTimes">전체</label> <label><input type="checkbox"
				name="time" value="주중">주중</label> <label><input
				type="checkbox" name="time" value="주말">주말</label> <label><input
				type="checkbox" name="time" value="주간">주간</label> <label><input
				type="checkbox" name="time" value="야간">야간</label> <label><input
				type="checkbox" name="time" value="입주">입주</label>
		</div>
		...
		<div class="checkbox" id="careQual">
			<h3>자격증 유무</h3>
			<label><input type="checkbox" name="qual" value="없음"
				id="noQual">없음</label> <label><input type="checkbox"
				name="qual" value="요양보호사">요양보호사</label> <label><input
				type="checkbox" name="qual" value="사회복지사">사회복지사</label> <label><input
				type="checkbox" name="qual" value="간호조무사">간호조무사</label> <label><input
				type="checkbox" name="qual" value="간호사">간호사</label> <label><input
				type="checkbox" name="qual" value="물리치료사">물리치료사</label> <label><input
				type="checkbox" name="qual" value="작업치료사">작업치료사</label>
		</div>

		<div class="dropdown" id="careYears">
			<h3>경력사항</h3>
			<label><input type="checkbox" name="years" value="전체"
				id="allYears">전체</label> <label><input type="checkbox"
				name="years" value="신규">신규</label> <label><input
				type="checkbox" name="years" value="1 ~ 2년">1 ~ 2년</label> <label><input
				type="checkbox" name="years" value="3 ~ 5년">3 ~ 5년</label> <label><input
				type="checkbox" name="years" value="5 ~ 10년">5 ~ 10년</label> <label><input
				type="checkbox" name="years" value="10년 이상">10년 이상</label>
		</div>

		<div class="dropdown" id="carePlace">
			<h3>희망 근무지역</h3>
			<label> <select name="sido1" id="sido1"></select> <select
				name="gugun1" id="gugun1"></select>
			</label> <label id="addr"> <!-- <input type="hidden" name="addr"> -->
			</label>
		</div>
...
<%@ include file="/views/match/list.jsp"%>
